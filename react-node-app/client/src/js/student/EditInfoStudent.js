...
const EditInfoStudent = () => {
    ...
    // const changeEmail = () => {
    //     const oldEmail = document.getElementById('old-email');
        
    //     if (oldEmail.value === student.email)
    //         oldEmail.style.cssText = 'outline: 2px solid green'
    // }
        ...
        <div className="container-page container">
            ...
            <section className='edit-info-student'>
                {/* <form className='edit-email'>
                    <label htmlFor='email'>تغير البريد الإلكتروني</label>
                    <input type='email' onChange={changeEmail} id='old-email' name='email' className='old' required placeholder='البريد الإلكتروني الحالي'/>
                    ...
                    <input type='email' name='email' className='new' required placeholder='البريد الإلكتروني الجديد' />
                ...
                <form className='edit-password' onSubmit={changePassword}>
                    ...
                    {/* <input type='password' name='password' className='old' required placeholder='كلمة المرور الحالية' /> */}
